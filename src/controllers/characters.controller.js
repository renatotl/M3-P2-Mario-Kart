...
if(allCharacters.length == 0){
    return res.status(404).send({message: "There are no characters registered!"})
}
...
const chooseCharacters = await charactersService.findCharacterByIdServicer(idParams);
